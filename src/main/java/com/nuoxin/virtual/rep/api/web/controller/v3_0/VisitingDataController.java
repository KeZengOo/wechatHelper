...
public class VisitingDataController extends NewBaseController implements Serializable {
    ...
    public DefaultResponseBean visitDataSummaryList(@RequestBody VisitDataRequest request) throws Exception {
        ...
        PageResponseBean<List<VisitDataResponse>> list = visitingDataService.getVisitDataByPage(leaderPath, request);
        DefaultResponseBean<PageResponseBean<List<VisitDataResponse>>> result = new DefaultResponseBean<>();
        result.setData(list);
        return result;
    }
