...
public class QuestionnaireAnalysisController extends BaseController {
    ...
    @GetMapping("/list")
    public DefaultResponseBean<List<String>> list(HttpServletRequest request, HttpServletResponse response) {
    ...
    public DefaultResponseBean<List<QuestionStatResponseBean>> details(@PathVariable Long id,
                                                                       HttpServletRequest request, HttpServletResponse response) {
