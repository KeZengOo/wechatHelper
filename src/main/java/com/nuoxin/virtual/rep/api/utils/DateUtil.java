...
public final class DateUtil {
  ...
  public static void main(String[] args){
	  Integer m=60*60*24*30*12*2;
	  System.out.println(format2.format(getYearMonthEndDate_Q(2017, 4)));
	  System.out.println(format2.format(getYearMonthStartDate_Q(2017, 4)));
  }
}
