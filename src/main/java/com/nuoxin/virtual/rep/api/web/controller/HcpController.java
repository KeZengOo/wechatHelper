...
public class HcpController extends BaseController {
	...
	public ResponseEntity<DefaultResponseBean<HcpBaseInfoResponseBean>> getMasterDataHcpBaseInfo(
			@PathVariable(value = "id") Long hcpId) {
	...
	public ResponseEntity<DefaultResponseBean<List<DoctorBasicInfoResponseBean>>> getHcpBaseInfo(
			@PathVariable(value = "id") Long hcpId) {
	...
	public ResponseEntity<DefaultResponseBean<Boolean>> getHcpBaseInfo(@RequestBody HcpBasicUpdateRequestBean bean,
	...
	public ResponseEntity<DefaultResponseBean<PageResponseBean<HcpDialogResponseBean>>> getDialogList(
			@RequestBody HcpRequestBean bean, HttpServletRequest request) {
	...
	public ResponseEntity<DefaultResponseBean<KeywordListResponseBean>> getKeywordList(@RequestBody HcpRequestBean bean,
			HttpServletRequest request) {
        Long loginId = getLoginId(request);
        bean.setDrugUserId(loginId);
	...
	public ResponseEntity<DefaultResponseBean<HcpResearchInfoResponseBean>> getHcpResearchInfo(
			@PathVariable(value = "id") Long hcpId) {
	...
	public ResponseEntity<DefaultResponseBean<PageResponseBean<HcpDocResponseBean>>> getDocList(@RequestBody HcpRequestBean bean,
			HttpServletRequest request) {
        Long loginId = getLoginId(request);
        bean.setDrugUserId(loginId);
